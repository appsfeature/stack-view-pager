package com.appsfeature.stackviewpager.fragment;
...
import com.appsfeature.stackviewpager.R;
...
public class CardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            cardNumTv.setText(bundle.getInt(INDEX_KEY, 0) + " "+cardNumTv.getText().toString());
        }
        cardNumTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getActivity(), "Clicked position:" + bundle.getInt(INDEX_KEY, 0) + "", Toast.LENGTH_SHORT).show();
            }
        });
        return v;
    }
